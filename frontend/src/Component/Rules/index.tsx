      ...
      <Container className="App-container-fix-height">
        ...
        <Row>
          <Col>
            ...
            <h6>This game with rules definitely demonstrates a future of lottery.</h6>
            <ul>
              <li>
                Crypto Lottery runs on Blockchain technology via Smart contract especially Ethereum keep innovative
                values: Transparent, Immutable, Distributed, Secure.
              </li>
              <li>Crypto Lottery is a fair game for everyone.</li>
              <li>
                Crypto Lottery contract was verified and published on the main net. Everyone can check and test it
                absolutely.
              </li>
              <li>
                Crypto Lottery contract was designed with a simple approach and structure to obey the rules, it can not
                be destroyed or change or upgrade the initial rules.
              </li>
              <li>
                Crypto Lottery game properties are dynamic and auto scale by session game time and no one can touch and
                guess it.
              </li>
              <li>
                Crypto Lottery random algorithm is smart and complex depend on a lot of incredible params. It's
                impossible to fake it even contract author.
              </li>
              <li>
                Crypto Lottery author creates rules and see what further happen and cannot touch on rules anymore.
              </li>
              <li>
                Crypto Lottery raises funds for charity. Play the game and make a bit of charity for life. If the
            ...
            <h3>Game Rules</h3>
            <h5>Crypto Lottery works like a game</h5>
            <ul>
              <li>
                The number player each round is random. The initial range is [5-7] and it will be adjusted
                automatically.
              </li>
              <li>
                The lucky number is random by system. The initial range is [0-255] and it will be adjusted
                automatically.
              </li>
              <li>
                One player joins the game by providing the name and some hopeful numbers. One player can register multi
                numbers, but only one time in one round.
              </li>
              <li>
                The system will distribute 60% total to every winning player who keeps the number is exact with the
                lucky number.
              </li>
              <li>
                The fund will retain 50% to accumulate to the next round if no winner in the current round. 10%
